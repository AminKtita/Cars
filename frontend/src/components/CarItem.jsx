    ...
    <div className="group relative bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
      <div className="cursor-pointer" onClick={handleClick}>
            ...
            {image.length > 3 && activeImageIndex === 2 && (
              <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                <div className="flex items-center text-white text-sm sm:text-base">
                  <img src={assets.camera} className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2" alt="camera" />
        ...
        <div className="p-3 sm:p-4">
          ...
          {/* Specifications */}
          <div className="grid grid-cols-3 gap-2 sm:gap-4 text-xs sm:text-sm border-t pt-3 sm:pt-4">
            {[
              {icon: assets.fuel, label: 'Fuel', value: fuel},
              {icon: assets.speedometer, label: 'Mileage', value: mileage},
